...
function startCounting() {
    const interval = setInterval(() => {
        if (count < 100) {
            ...
            document.body.style.backgroundColor = 'orange'; // Меняем фон на светло-серый
            titleElement.style.color = '#0aed65'; // Меняем цвет цифры на зеленый
            titleElement.style.fontSize = '70px'; // Меняем размер шрифта на 30px
            wrapper__nav.style.backgroundColor = 'purple'; // Меняем цвет фона навигации на оранжевый
        }
